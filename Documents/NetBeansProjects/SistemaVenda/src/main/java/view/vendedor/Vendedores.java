...
import static view.cliente.Clientes.tableClientes;
...
public class Vendedores extends javax.swing.JDialog {
    ...
    private TableModelVendedor aTableModelVendedor;
    
    /**
     * Creates new form NewJDialog
     */
    public Vendedores(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents(); 
        setIcon();
        atualizaDados();
    ...
    private void initComponents() {
        ...
        cadastrar_paciente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-addgrupo-de-usuários-mulher-homem-48.png"))); // NOI18N
        ...
        editar_paciente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-grupo-de-usuário-homem-mulher-48.png"))); // NOI18N
        ...
        deletar_paciente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-adicionar-grupo-de-usuários-mulher-homem-48.png"))); // NOI18N
        ...
        tableVendedor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "Nascimento", "Telefone", "Salário", "Endereço"
            }
        ) {
        ...
        tableVendedor.setMaximumSize(new java.awt.Dimension(300, 0));
    ...
    private void cadastrar_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrar_pacienteActionPerformed
        CadastrarVendedor dialog = new CadastrarVendedor(this, true);
    ...
    private void editar_pacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editar_pacienteActionPerformed
        ...
        Vendedor v = vendedor.get(tableVendedor.getSelectedRow());
        EditarVendedor dialog = new EditarVendedor(this, true, vService, v);
        dialog.setVisible(true);
        atualizaDados();
  ...
  if (tableVendedor.getSelectedRow() == -1) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Vendedores dialog = new Vendedores(new javax.swing.JDialog(), true);
    ...
    public static javax.swing.JTable tableVendedor;
 ...
 //1-buscando os dados do BD
        vendedor = vService.buscarTodos();
        //2-configurando o modelo com os dados do bd
        aTableModelVendedor = new TableModelVendedor(vendedor);
        //3-configurando o Jtable com o modelo criado
        tableVendedor.setModel(aTableModelVendedor);    }
}
