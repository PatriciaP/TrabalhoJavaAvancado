...
public class Clientes extends javax.swing.JDialog {
    ...
    private final ClienteService cService = new ClienteService();
    private List<model.Cliente> clientes;
    private TableModelCliente aTableModelCliente;
    ...
    private void initComponents() {
        ...
        tableClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "CPF", "Nome", "Nascimento", "Telefone", "Categoria", "Endereço"
            }
        ) {
        ...
        tableClientes.setMaximumSize(new java.awt.Dimension(300, 0));
    ...
    private void atualizaDados() {
        ...
        clientes = cService.buscarTodos();
        //2-configurando o modelo com os dados do bd
        aTableModelCliente = new TableModelCliente(clientes);
        //3-configurando o Jtable com o modelo criado
        tableClientes.setModel(aTableModelCliente);
    }
}
